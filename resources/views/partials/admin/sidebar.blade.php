<nav id="sidebarMenu" class="col-md-3 col-lg-2 d-md-block bg-light sidebar collapse">
    <div class="position-sticky d-flex flex-column justify-content-between h-100 pt-3">
        <ul class="nav flex-column">
            ...
            <li class="nav-item">
                <a class="nav-link {{ Route::currentRouteName() === 'admin.dishes.index' ? 'active shadow rounded' : '' }} || {{ Route::currentRouteName() === 'admin.dishes.show' ? 'active shadow rounded' : '' }} || {{ Route::currentRouteName() === 'admin.dishes.create' ? 'active shadow rounded' : '' }} || {{ Route::currentRouteName() === 'admin.dishes.edit' ? 'active shadow rounded' : '' }}"

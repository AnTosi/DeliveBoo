...
<div class="d-flex">
    <div class="container-fliud">
        <img width="100%" height="200" style="filter: blur(20px)" src="{{ asset('storage/restaurant_image/' . $user->id . '/' . $user->image) }}" alt="...">
    </div>
                    ...
                    <div class="col dish">
                        <div class="info_wrap pt-4 pb-2 px-5 shadow-lg p-3 mb-5 bg-body ">
                            <div class="row row-cols-2">
                                <div class="col-3"><img src="{{ asset('storage/' . $dish->image) }}" class="img-fluid rounded-circle" height="100" width="100" alt="">
                                </div>
                                <div class="col-9">
                                    ...
                                    <div class="flex-column">
                                        ...
                                        <div class="card bg-primary text-white rounded-3">
                                            <div class="card-body">
                                                ...
                                                <button type="button" id="submit-button" class="btn btn-info btn-block btn-lg">
                                                    <div class="d-flex justify-content-between">
                                                        <span>$4818.00</span>

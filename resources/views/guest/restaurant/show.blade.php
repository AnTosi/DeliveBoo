            ...
            <div class="row row-cols-1 row-cols-xl-2 g-3">
                ...
                <div class="col dish">
                    <div class="info_wrap pt-4 pb-2 px-5 bg-white shadow-lg ">
                        <button data-bs-toggle="modal" data-bs-target="#show-{{ $dish->slug }}" class="border-0 bg-white col-9">
                            <div class="row row-cols-2 align-items-center">
                                <div class="col-4"><img src="{{ asset('storage/' . $dish->image) }}" class="rounded-circle" style="object-fit:cover; width:75px; height:75px" alt="">
                                </div>
                                <div class="col-8">
                        ...
                        <div class="row row-cols-2 justify-content-between align-items-center bg-white">
                            ...
                            <div v-on:click="addToCart({{ json_encode($dish) }})" class="col-9 d-flex justify-content-center align-items-center add_to_cart">
                            ...
                            <div class="card-body p-4 shadow-lg" style="border-radius: 1rem;">
                                ...
                                <div class="row">
                                    ...
                                    <div class="flex-column">
                                        ...
                                        <button type="button" id="submit-button" class="btn text_secondary bg_secondary_smooth btn-block btn-lg">

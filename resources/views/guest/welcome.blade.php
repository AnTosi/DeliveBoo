...
<div class="tags-container">
    <div class="row row-cols-1 row-cols-md-2 row-cols-lg-4 w-50 mx-auto container my-auto pt-3  justify-content-center flex-wrap g-3">
        @foreach ($tags as $tag)
        ...
        <div class="col">
            <a :href="user.slug">
                <div class="card" aria-hidden="true">
                    <img class="card-img-top" :src="'/storage/restaurant_logo' + '/' + user.id + '/' + user.logo " alt="">
                    <div class="card-body">
                        <h5 class="card-title">
